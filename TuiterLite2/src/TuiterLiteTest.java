...
public class TuiterLiteTest {
    ...
    public void testeAutorDoTuite()
            throws TamanhoMaximoExcedidoException, UsuarioDesconhecidoException, EmptyStringException {
...
//    }
    ...
    @Test
    public void testeTamanhoTuite() throws UsuarioDesconhecidoException, EmptyStringException {
    ...
    public void testeApenasUmTipoPermitidoComoAnexo()
            throws TamanhoMaximoExcedidoException, UsuarioDesconhecidoException, UsuarioJaExisteException, EmptyStringException {
...
//        tuite.anexarAlgo(new Object());  // essa linha, se fosse descomentada, daria erro de compilação
    ...
    @Test
    public void testarMultiplosSimbolosDeHashtag() throws UsuarioDesconhecidoException, EmptyStringException, TamanhoMaximoExcedidoException {
...
//
    ...
    /////
    @Test
    public void testePerformanceTuites() throws UsuarioJaExisteException, TamanhoMaximoExcedidoException, EmptyStringException {
    ...
    @Test
    public void testeStringVaziaTuite() throws UsuarioDesconhecidoException, TamanhoMaximoExcedidoException {

        try {
            tuiterLite.tuitarAlgo(usuario, "");
            fail("Um tuite com uma String vazia deve lançar uma EmptyStringException");

        } catch (EmptyStringException e) {
            assertEquals("Não é possivel fazer um tuite com texto vazio.", e.getMessage());
        }
    }

    @Test
    public void testarUsuarioNaoCadastrado() throws EmptyStringException, TamanhoMaximoExcedidoException {
        Usuario novo = new Usuario("Beltrano", "beltrano@teste.com");

        try {
            tuiterLite.tuitarAlgo(novo, "#teste");
            fail("Um tuite com um usuario desconhecido deve lançar uma UsuarioDesconhecidoException");

        } catch (UsuarioDesconhecidoException e) {
            assertEquals("A exceção deve comunicar corretamente o usuario desconhecido que tentou tuitar",
                    novo.getEmail(), e.getEmail());
        }
    }
